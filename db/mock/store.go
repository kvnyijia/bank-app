...
// Source: github.com/kvnyijia/bank-app/db/sqlc (interfaces: Store)
...
// ListTarnsfer mocks base method.
func (m *MockStore) ListTarnsfer(arg0 context.Context, arg1 db.ListTarnsferParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTarnsfer", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListTarnsfer indicates an expected call of ListTarnsfer.
func (mr *MockStoreMockRecorder) ListTarnsfer(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTarnsfer", reflect.TypeOf((*MockStore)(nil).ListTarnsfer), arg0, arg1)
}
